...
Sample "microservice app" with datamodel generated out of JDL schema and manually created DTO for processing custom JSON
...
This application is configured without Service Discovery and Configuration with . On launch, it will refuse to start if it is not able to connect to .
...
To optimize the ScannerSrv application for production, run:
